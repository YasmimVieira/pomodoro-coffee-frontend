  ...
  return (
    ...
    >
      ...
      <View style={[styles.sheet, { paddingBottom: insets.bottom + 20 }]}>
        ...
        <Text style={styles.title}>Configurações do ciclo</Text>
        <Text style={styles.total}>Ciclo total: {totalMin} min</Text>

        <OptionRow
          label="FOCO"
          options={FOCUS_OPTIONS}
          selected={focusMin}
          onSelect={setFocusMin}
        />
        <OptionRow
          label="PAUSA"
...
const styles = StyleSheet.create({
  ...
  btn: {
    ...
    borderRadius: 16, backgroundColor: colors.amberLight,
    alignItems: 'center',
  },
